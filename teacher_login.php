...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if (!hash_equals($csrfToken, $postedToken)) {
    ...
    if ($_SESSION[$rateKey]['count'] >= $maxAttempts) {
      ...
      if ($stmt === false) {
        error_log('Teacher login prepare failed: ' . $conn->error);
...
<head>
  ...
  <style>
    :root { --bg-img: url('https://img.freepik.com/premium-vector/female-teacher-classroom-school-learning-concept-teachers-day_113065-1042.jpg'); }
