...
if ($role === 'student' && isset($_POST['submit_quiz']) && $assignment) {
    ...
    header("Location: view_quiz.php?content_id=$content_id&course_id=$course_id&view_attempt=$attempt_id&submitted=1");
    exit;
}
...
<body class="bg-gray-50 text-gray-800 min-h-screen">
    ...
    <main class="max-w-7xl mx-auto px-4 py-10 pt-24">
        ...
        <a href="course.php?course_id=<?= $course_id ?>" class="inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 mb-6 transition">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <?php if ($review_mode): ?>
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <a href="view_quiz.php?content_id=<?=$content_id?>&course_id=<?=$course_id?>" 
                ...
                <div class="lg:col-span-1 space-y-6">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 sticky top-24">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <?php if($review_mode): ?>
                                <a href="view_quiz.php?content_id=<?=$content_id?>&course_id=<?=$course_id?>" class="text-xs text-blue-600 hover:underline">Take New</a>
                            <?php endif; ?>
                        </div>
                            ...
                            <div class="space-y-3">
                                ...
                                ?>
                                    <div class="border rounded-lg p-3 bg-white hover:bg-gray-50 transition <?= $activeClass ?>">
                                        ...
                                        <a href="view_quiz.php?content_id=<?=$content_id?>&course_id=<?=$course_id?>&view_attempt=<?=$att['attempt_id']?>" 
