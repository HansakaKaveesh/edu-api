        ...
        <div class="rounded-2xl bg-white/90 backdrop-blur ring-1 ring-gray-200 p-6 card">
          <form method="POST" enctype="multipart/form-data" class="space-y-10">
            ...
            <section>
              ...
              <div class="flex items-center gap-6">
                ...
                <div>
                  ...
                  <input type="file" name="profile_pic" accept="image/*" class="block w-full text-sm text-gray-700 border border-gray-200 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" onchange="previewFile(this)">
            ...
            <section>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                <div class="icon-input">
                  ...
                  <input type="text" name="first_name" value="<?= htmlspecialchars($studentData['first_name'] ?? '') ?>" required class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-300" />
                </div>

                <div class="icon-input">
                  <label class="block font-medium mb-1">Last Name</label>
                  <ion-icon name="person-circle-outline"></ion-icon>
                  <input type="text" name="last_name" value="<?= htmlspecialchars($studentData['last_name'] ?? '') ?>" required class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-300" />
                </div>

                <div class="icon-input">
                  <label class="block font-medium mb-1">Date of Birth</label>
                  <ion-icon name="calendar-outline"></ion-icon>
                  <input type="date" name="dob" value="<?= htmlspecialchars($studentData['dob'] ?? '') ?>" required class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-300" />
                </div>

                <div class="icon-input">
                  <label class="block font-medium mb-1">Contact Number</label>
                  <ion-icon name="call-outline"></ion-icon>
                  <input type="tel" name="contact_number" value="<?= htmlspecialchars($studentData['contact_number'] ?? '') ?>" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-300" />
                </div>

                <div class="icon-input md:col-span-2">
                  <label class="block font-medium mb-1">Email</label>
                  <ion-icon name="mail-outline"></ion-icon>
                  <input type="email" name="email" value="<?= htmlspecialchars($studentData['email'] ?? '') ?>" required class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-300" />
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input id="password" type="password" name="password" class="w-full pl-10 pr-24 px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-300" />
                  <button type="button" id="togglePw" class="absolute right-2 top-1/2 -translate-y-1/2 inline-flex items-center gap-1 text-gray-600 hover:text-gray-800 text-sm px-2 py-1 rounded">
            ...
            <div class="flex items-center justify-between pt-2">
              ...
              <button type="submit" class="inline-flex items-center gap-2 bg-indigo-600 text-white px-6 py-2.5 rounded-lg hover:bg-indigo-700 shadow-sm">
