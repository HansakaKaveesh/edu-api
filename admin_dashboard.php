...
<!-- Hero Section -->
<section class="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white py-20 px-6 md:px-12 rounded-b-3xl shadow-lg">
  <div class="max-w-7xl mx-auto text-center md:text-left mt-10">
    ...
    <p class="mt-4 text-lg md:text-xl max-w-3xl mx-auto md:mx-0 drop-shadow-md">
      Monitor students, teachers, courses, and revenue all in one place.
      Manage your platform effortlessly with our comprehensive admin dashboard.
    </p>
  </div>
</section>
...
<main class="container mx-auto px-6 py-12 flex-grow">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 col-span-1 md:col-span-2 lg:col-span-3 hover:shadow-2xl transition-shadow duration-300">
...
<footer class="bg-indigo-700 text-white text-center py-6 mt-auto shadow-inner">
  <p>© <?= date('Y') ?> YourPlatformName. All rights reserved.</p>
</footer>

<!-- Optional wave animation style -->
<style>
  @keyframes wave {
    0%, 60%, 100% {
