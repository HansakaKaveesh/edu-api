...
<body class="bg-[url('https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=1470&q=80')] bg-cover bg-center min-h-screen flex flex-col text-gray-800">

  <!-- Navbar include or fallback -->
  ...
  <?php else: ?>
    <nav class="bg-white/90 backdrop-blur border-b border-gray-200 sticky top-0 z-40">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        <a href="index.php" class="font-bold text-gray-800">SynapZ</a>
        <div class="flex items-center gap-4 text-sm">
          <a href="index.php" class="text-gray-700 hover:text-blue-700">Home</a>
          <a href="admin_login.php" class="text-gray-700 hover:text-blue-700">Admin</a>
          <a href="ceo_login.php" class="text-gray-700 hover:text-blue-700">CEO</a>
          <a href="accountant_login.php" class="text-gray-700 hover:text-blue-700">Accountant</a>
        </div>
      </div>
    </nav>
  <?php endif; ?>
  ...
  <?php else: ?>
    <footer class="bg-white/90 backdrop-blur border-t border-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 text-sm text-gray-600 flex items-center justify-between">
        <span>&copy; <?= date('Y') ?> SynapZ. All rights reserved.</span>
        <div class="flex items-center gap-4">
          <a href="privacy.php" class="hover:text-gray-800">Privacy</a>
          <a href="terms.php" class="hover:text-gray-800">Terms</a>
        </div>
      </div>
    </footer>
  <?php endif; ?>
