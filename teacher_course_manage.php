...
$course_name  = htmlspecialchars($course['name'], ENT_QUOTES, 'UTF-8');
...
/* teacher name for sidebar */
$teacher_name = 'Teacher';
if ($stmt = $conn->prepare("SELECT first_name, last_name FROM teachers WHERE user_id = ? LIMIT 1")) {
...
/* which item is active in teacher sidebar */
$active = 'courses';

/* optional counts for badges (can be filled later if you want) */
$counts = [];
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="max-w-8xl mx-auto px-6 py-10 lg:flex lg:gap-6">

  <!-- Teacher Sidebar column -->
  <div class="lg:w-72 lg:shrink-0 mb-6 lg:mb-0">
    <?php include 'components/teacher_sidebar.php'; ?>
  </div>

  <!-- Main content -->
  <div class="flex-1" x-data="{ show:false, iframeSrc:'' }">

    

    <!-- Hero / Course header -->
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-sky-500 text-white shadow-lg mb-8 mt-16">
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-slate-500">
                  Manage all <?= htmlspecialchars($type, ENT_QUOTES, 'UTF-8') ?>-type content for this course.
                </p>
              </div>
            </div>
          </div>
